...
OUT = "C:/Users/PC/OneDrive/Desktop/kuberan web/reports/dilaksi/data/2026-07-02_req1-ga4-organic-windows.json"
...
for days in (60, 45, 30, 15, 7):
    ...
    # per landing page, top 200 by sessions
    ...
    print(days, "days: pages", resp.row_count, "sessions", t[0], "revenue", t[6])
