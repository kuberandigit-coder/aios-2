# Kamsi Requirement 3 — GSC top query per page, ALL pages (no /collections/ filter),
# last 30 days, matching Dilaksi Req1's query-enrichment scope. Uses requests transport
# (httplib2 times out in this environment — same fix as the original req3 GSC fetch).
import csv, requests
...
URL = "https://searchconsole.googleapis.com/webmasters/v3/sites/sc-domain%3Aledsone.co.uk/searchAnalytics/query"
...
with open("2026-07-06_kamsi_req3_gsc_top_query_allpages_30d.csv", "w", newline="", encoding="utf-8") as f:
    w = csv.writer(f)
