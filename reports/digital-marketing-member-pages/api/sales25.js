...
const GROUPS = [
  ...
  },
  {
    ...
    scope: 'the order matches Organic\'s rule (see below) AND contains one of Kamsi\'s owned product IDs. Split out of the shared Organic tab (per user request, 2026-07-30, same as the 2026 salesuk.js split) — checked before Organic and Dilaksi.',
  ...
  },
  {
    ...
    name: 'Dilaksi',
    department: 'Organic (product-scoped)',
    scope: 'the order matches Organic\'s rule (see below) AND contains one of Dilaksi\'s owned product IDs. Split out of the shared Organic tab (per user request, 2026-07-30). Checked after Kamsi (1 product ID appears in both lists as given by the user, resolves to Kamsi) and before Organic.',
