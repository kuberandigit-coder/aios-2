// Sukirtha — Email Marketing Sales (ledsone.de), store-wide (NOT product-scoped)
...
//
// Same Email classification logic as sales-sukirtha-uk.js, pointed at the
// DE store/token, plus the July-2026 live-month-to-date support added to
// sales-kamsi.js on 2026-07-17 (CURRENT_LIVE_MONTHS / month-to-date end
// boundary), backported here from day one.
//
...
// ---------- Session classification (identical logic to sales-sukirtha-uk.js) ----------
...
const ORDERS_QUERY = `
query SukirthaDEEmailOrders($cursor: String, $query: String!) {
